...
assert.match(formCss, /\.aiditor-inspector-body\s*\{[\s\S]*?padding:\s*0;/)
assert.match(formCss, /\.aiditor-inspector-body\s*>\s*\.aiditor-ui-property-form\s*\{[\s\S]*?min-height:\s*100%;/)
assert.match(formCss, /\.aiditor-ui-section\.aiditor-ui-property-section\s*\{[\s\S]*?border:\s*var\(--aiditor-surface-border-w\) solid var\(--aiditor-property-section-border\);[\s\S]*?background:\s*var\(--aiditor-property-section-bg\);/)
assert.match(formCss, /\.aiditor-ui-property-section:not\(\.aiditor-ui-section-collapsed\)\s*>\s*\.aiditor-ui-section-head\s*\{[\s\S]*?border-radius:/)
assert.match(formCss, /\.aiditor-ui-property-section\.aiditor-ui-section-collapsed\s*>\s*\.aiditor-ui-section-head\s*\{[\s\S]*?border-radius:\s*var\(--aiditor-radius-surface\);/)
assert.match(formCss, /\.aiditor-ui-property-section\s*>\s*\.aiditor-ui-section-body\s*\{[\s\S]*?padding:\s*var\(--aiditor-property-section-spacing\);[\s\S]*?background:\s*var\(--aiditor-property-section-body-bg\);/)
assert.match(formCss, /\.aiditor-ui-property-form\s*\{[\s\S]*?gap:\s*var\(--aiditor-property-section-spacing\);/)
assert.match(formCss, /\.aiditor-ui-property-form\[inert\][^{]*\.aiditor-ui-section-head:hover\s*\{[\s\S]*?background:\s*var\(--aiditor-property-section-head-bg\);/)
